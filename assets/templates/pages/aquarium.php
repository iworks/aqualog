...
<div class="wrap">
	...
	<section class="aquarium-log-dashboard-section aquarium-log-dashboard-grid">
		<div class="aquarium-log-aquarium-info">
			...
			<div class="aquarium-log-info-cards">
				<div class="aquarium-log-info-card aquarium-log-info-card--period">
					<h3><?php esc_html_e( 'Period of operation', 'iworks-aquarium-log' ); ?></h3>
					<div class="aquarium-log-info-card-row">
						<div class="aquarium-log-info-card-cell aquarium-log-info-card-cell__start">
							...
							<span class="label"><?php esc_html_e( 'Start Date:', 'iworks-aquarium-log' ); ?></span>
							<span class="value"><?php echo esc_html( $args['aquarium']['meta']['_iw_date_started'] ); ?></span>
						</div>
						<div class="aquarium-log-info-card-cell aquarium-log-info-card-cell__update">
							...
							<span class="label"><?php esc_html_e( 'Last Update:', 'iworks-aquarium-log' ); ?></span>
							<span class="value"><?php echo esc_html( $args['aquarium']['meta']['_iw_date_updated'] ); ?></span>
						</div>
						<div class="aquarium-log-info-card-cell aquarium-log-info-card-cell__end">
							...
							<span class="label"><?php esc_html_e( 'Aquarium End Date:', 'iworks-aquarium-log' ); ?></span>
							<span class="value"><?php echo esc_html( $args['aquarium']['meta']['_iw_date_closed'] ); ?></span>
						</div>
					</div>
				</div>
				<div class="aquarium-log-info-card aquarium-log-info-card--dimensions">
					<h3><?php esc_html_e( 'Aquarium Dimensions', 'iworks-aquarium-log' ); ?></h3>
					<div class="aquarium-log-info-card-row aquarium-log-info-card-row--capacity">
						<div class="aquarium-log-info-card-cell aquarium-log-info-card-cell__capacity">
							...
							<span class="label"><?php esc_html_e( 'Tank Capacity:', 'iworks-aquarium-log' ); ?></span>
							<span class="value"><?php echo esc_html( $args['aquarium']['meta']['_iw_size_capacity'] ); ?> <span><?php echo esc_html_x( 'L', 'liters abbreviation', 'iworks-aquarium-log' ); ?></span></span>
						</div>
						<div class="aquarium-log-info-card-cell aquarium-log-info-card-cell__volume">
							...
							<span class="label"><?php esc_html_e( 'Water Volume in Tank:', 'iworks-aquarium-log' ); ?></span>
							<span class="value"><?php echo esc_html( $args['aquarium']['meta']['_iw_size_water_volume'] ); ?> <span><?php echo esc_html_x( 'L', 'liters abbreviation', 'iworks-aquarium-log' ); ?></span></span>
						</div>
					</div>
					<div class="aquarium-log-info-card-row aquarium-log-info-card-row--dimensions">
						<div class="aquarium-log-info-card-cell aquarium-log-info-card-cell__width">
							...
							<span class="label"><?php esc_html_e( 'Tank Width:', 'iworks-aquarium-log' ); ?></span>
							<span class="value"><?php echo esc_html( $args['aquarium']['meta']['_iw_size_width'] ); ?> <span><?php echo esc_html_x( 'cm', 'centimeters abbreviation', 'iworks-aquarium-log' ); ?></span></span>
						</div>
						<div class="aquarium-log-info-card-cell aquarium-log-info-card-cell__height">
							...
							<span class="label"><?php esc_html_e( 'Tank Height:', 'iworks-aquarium-log' ); ?></span>
							<span class="value"><?php echo esc_html( $args['aquarium']['meta']['_iw_size_height'] ); ?> <span><?php echo esc_html_x( 'cm', 'centimeters abbreviation', 'iworks-aquarium-log' ); ?></span></span>
						</div>
						<div class="aquarium-log-info-card-cell aquarium-log-info-card-cell__depth">
							...
							<span class="label"><?php esc_html_e( 'Tank Depth:', 'iworks-aquarium-log' ); ?></span>
							<span class="value"><?php echo esc_html( $args['aquarium']['meta']['_iw_size_depth'] ); ?> <span><?php echo esc_html_x( 'cm', 'centimeters abbreviation', 'iworks-aquarium-log' ); ?></span></span>
						</div>
					</div>
				</div>
			</div>
	...
	<section class="aquarium-log-dashboard-section aquarium-log-events">
		...
		<div class="aquarium-log-events-rows">
			<?php
			/**
			 ...
			 */
			do_action( 'iworks-aquarium-log/aquarium/events/latest', $args['aquarium_id'] );
			?>
		</div>
	</section>
