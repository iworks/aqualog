...
window.console.log(window.aqualog.chemistry.formData);
	...
	window.aqualog.chemistry.initializeForm = function() {
		...
		if ($.fn.slider) {
			$form.find('.aqualog-form-input--number').slider({
				min: $($form.find('.aqualog-form-input--number')).data('range-min'),
				max: $($form.find('.aqualog-form-input--number')).data('range-max'),
				step: $($form.find('.aqualog-form-input--number')).data('range-step')
			});
		}
	};
