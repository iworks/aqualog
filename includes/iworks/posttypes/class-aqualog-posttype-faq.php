...
class iworks_aqualog_posttype_faq extends iworks_aqualog_posttype_base {
	...
	public function action_init_register_post_type() {
		...
		$labels = array(
			'name'               => _x( 'FAQs', 'Post Type General Name', 'aqualog' ),
			'singular_name'      => _x( 'FAQ', 'Post Type Singular Name', 'aqualog' ),
			'menu_name'          => _x( 'FAQs', 'Menu Name', 'aqualog' ),
			'name_admin_bar'     => _x( 'FAQ', 'Admin Bar Name', 'aqualog' ),
			'parent_item_colon'  => __( 'Parent FAQ:', 'aqualog' ),
			'all_items'          => __( 'FAQs', 'aqualog' ),
			'add_new_item'       => __( 'Add New FAQ', 'aqualog' ),
			'add_new'            => __( 'Add New', 'aqualog' ),
			'new_item'           => __( 'New FAQ', 'aqualog' ),
			'edit_item'          => __( 'Edit FAQ', 'aqualog' ),
			'update_item'        => __( 'Update FAQ', 'aqualog' ),
			'view_item'          => __( 'View FAQ', 'aqualog' ),
			'search_items'       => __( 'Search FAQ', 'aqualog' ),
			'not_found'          => __( 'Not found', 'aqualog' ),
			'not_found_in_trash' => __( 'Not found in Trash', 'aqualog' ),
		);

		$args = array(
			'label'               => __( 'faq', 'aqualog' ),
			'description'         => __( 'Frequently Asked Questions', 'aqualog' ),
			...
			'rest_base'           => apply_filters(
				...
				defined( 'ICL_SITEPRESS_VERSION' ) ? 'faqs' : __( 'faqs', 'aqualog' )
			),
		);
		register_post_type(
	...
	public function action_init_register_taxonomy() {
		...
		$labels = array(
			'name'                       => _x( 'FAQ Groups', 'Taxonomy General Name', 'aqualog' ),
			'singular_name'              => _x( 'FAQ Group', 'Taxonomy Singular Name', 'aqualog' ),
			'menu_name'                  => __( 'Groups', 'aqualog' ),
			'all_items'                  => __( 'All FAQ Groups', 'aqualog' ),
			'parent_item'                => __( 'Parent FAQ Group', 'aqualog' ),
			'parent_item_colon'          => __( 'Parent FAQ Group:', 'aqualog' ),
			'new_item_name'              => __( 'New FAQ Group Name', 'aqualog' ),
			'add_new_item'               => __( 'Add New FAQ Group', 'aqualog' ),
			'edit_item'                  => __( 'Edit FAQ Group', 'aqualog' ),
			'update_item'                => __( 'Update FAQ Group', 'aqualog' ),
			'view_item'                  => __( 'View FAQ Group', 'aqualog' ),
			'separate_items_with_commas' => __( 'Separate FAQ Groups with commas', 'aqualog' ),
			'add_or_remove_items'        => __( 'Add or remove FAQ Groups', 'aqualog' ),
			'choose_from_most_used'      => __( 'Choose from the most used', 'aqualog' ),
			'popular_items'              => __( 'Popular FAQ Groups', 'aqualog' ),
			'search_items'               => __( 'Search FAQ Groups', 'aqualog' ),
			'not_found'                  => __( 'Not Found', 'aqualog' ),
		);
		...
		$args = array(
			...
			'rest_base'           => apply_filters(
				...
				defined( 'ICL_SITEPRESS_VERSION' ) ? 'faq_groups' : __( 'faq_groups', 'aqualog' )
			),
		);
		...
		if ( 'show' === $args['header'] ) {
			...
			if ( 'show' === $args['header-button'] ) {
				$content .= sprintf(
					...
					esc_attr__( 'Expand All', 'aqualog' ),
					esc_attr( $args['id'] ),
					esc_html__( 'Expand All', 'aqualog' )
				);
			}
