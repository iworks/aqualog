...
class iworks_aqualog_posttype_hero extends iworks_aqualog_posttype_base {
	...
	public function get_list( $atts, $content = '' ) {
		...
		$content .= sprintf(
			'<h2>%s</h2>',
			esc_html__( 'Learn what our employees are saying.', 'aqualog' )
		);
		$content .= sprintf(
			'<p class="become-one-of-them">%s</p>',
			esc_html__( 'Become one of them!', 'aqualog' )
		);
		$content .= '<ul>';
	...
	public function action_init_register_post_type() {
		$labels = array(
			'name'                  => _x( 'Heroes', 'Post Type General Name', 'aqualog' ),
			'singular_name'         => _x( 'Hero', 'Post Type Singular Name', 'aqualog' ),
			'menu_name'             => __( 'Heroes', 'aqualog' ),
			'name_admin_bar'        => __( 'Heroes', 'aqualog' ),
			'archives'              => __( 'Heroes', 'aqualog' ),
			'all_items'             => __( 'Heroes', 'aqualog' ),
			'add_new_item'          => __( 'Add New Hero', 'aqualog' ),
			'add_new'               => __( 'Add New', 'aqualog' ),
			'new_item'              => __( 'New Hero', 'aqualog' ),
			'edit_item'             => __( 'Edit Hero', 'aqualog' ),
			'update_item'           => __( 'Update Hero', 'aqualog' ),
			'view_item'             => __( 'View Hero', 'aqualog' ),
			'view_items'            => __( 'View Hero', 'aqualog' ),
			'search_items'          => __( 'Search Hero', 'aqualog' ),
			'not_found'             => __( 'Not found', 'aqualog' ),
			'not_found_in_trash'    => __( 'Not found in Trash', 'aqualog' ),
			'items_list'            => __( 'Hero list', 'aqualog' ),
			'items_list_navigation' => __( 'Hero list navigation', 'aqualog' ),
			'filter_items_list'     => __( 'Filter items list', 'aqualog' ),
		);
		$args   = array(
			'can_export'          => true,
			'capability_type'     => 'page',
			'description'         => __( 'Hero', 'aqualog' ),
			'exclude_from_search' => true,
			'has_archive'         => false,
			'hierarchical'        => false,
			'label'               => __( 'Heroes', 'aqualog' ),
			'labels'              => $labels,
