...
class iworks_aqualog_posttype_publication extends iworks_aqualog_posttype_base {
			...
			'publication-data' => array(
				...
				'fields' => array(
					array(
						'name'  => 'language',
						'type'  => 'select',
						'label' => esc_html__( 'Language', 'aqualog' ),
					),
					array(
						'name'  => 'year',
						'type'  => 'year',
						'label' => esc_html__( 'Year', 'aqualog' ),
					),
					array(
						'name'  => 'authors',
						'label' => esc_html__( 'Authors', 'aqualog' ),
					),
					array(
						'name'  => 'where',
						'label' => esc_html__( 'Where', 'aqualog' ),
					),
					array(
						'name'  => 'url',
						'type'  => 'url',
						'label' => esc_html__( 'URL', 'aqualog' ),
					),
					array(
						'name'  => 'conference',
						'label' => esc_html__( 'Conference', 'aqualog' ),
					),
				),
			),
		);
	...
	public function get_random( $content, $args ) {
		...
		if ( 'pl_PL' === get_locale() ) {
			...
			$content .= sprintf( '<span class="section-title">%s</span>', esc_html__( 'Scientific publications of OPI PIB', 'aqualog' ) );
		}
	...
	public function action_init_register_post_type() {
		$labels = array(
			'name'                  => _x( 'Publications', 'Post Type General Name', 'aqualog' ),
			'singular_name'         => _x( 'Publication', 'Post Type Singular Name', 'aqualog' ),
			'menu_name'             => __( 'Publications', 'aqualog' ),
			'name_admin_bar'        => __( 'Publications', 'aqualog' ),
			'archives'              => __( 'Publications', 'aqualog' ),
			'all_items'             => __( 'Publications', 'aqualog' ),
			'add_new_item'          => __( 'Add New Publication', 'aqualog' ),
			'add_new'               => __( 'Add New', 'aqualog' ),
			'new_item'              => __( 'New Publication', 'aqualog' ),
			'edit_item'             => __( 'Edit Publication', 'aqualog' ),
			'update_item'           => __( 'Update Publication', 'aqualog' ),
			'view_item'             => __( 'View Publication', 'aqualog' ),
			'view_items'            => __( 'View Publication', 'aqualog' ),
			'search_items'          => __( 'Search Publication', 'aqualog' ),
			'not_found'             => __( 'Not found', 'aqualog' ),
			'not_found_in_trash'    => __( 'Not found in Trash', 'aqualog' ),
			'items_list'            => __( 'Publication list', 'aqualog' ),
			'items_list_navigation' => __( 'Publication list navigation', 'aqualog' ),
			'filter_items_list'     => __( 'Filter items list', 'aqualog' ),
		);
		$args   = array(
			'can_export'          => true,
			'capability_type'     => 'page',
			'description'         => __( 'Publication', 'aqualog' ),
			'exclude_from_search' => true,
			'has_archive'         => true,
			'hierarchical'        => false,
			'label'               => __( 'Publications', 'aqualog' ),
			'labels'              => $labels,
